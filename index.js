...
class Calculadora {
    ...
    imprimirPantalla(){valorAbajo.innerHTML=this.valorInferior;valorArriba.innerHTML=this.valorSuperior;}
    borrar(){this.valorInferior=this.valorInferior.slice(0,-1);this.imprimirPantalla(); }
    borrarTodo(){this.valorInferior="";this.valorSuperior=""; this.imprimirPantalla();}
    calcular(){
        ...
        if(isNaN==valorInferiorNumber || isNaN==valorSuperiorNumber){return}
        switch (this.operador) {
        case "+":  resultado= Number((valorSuperiorNumber + valorInferiorNumber).toFixed(2)) 
        break;
        case"-": resultado= Number((valorSuperiorNumber - valorInferiorNumber).toFixed(2)) 
         break;
        case"*": resultado= Number((valorSuperiorNumber * valorInferiorNumber).toFixed(2))
...
this.valorSuperior=valorSuperiorNumber + this.operador + valorInferiorNumber
this.operador=undefined
this.imprimirPantalla()
